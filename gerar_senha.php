        ...
        <section class="row justify-content-center">
            <div class="col-lg-5 mt-5">
                ...
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        <input type="submit" value=":: Criar nova senha ::" name="criar" class="btn btn-info btn-block" style="font-weight: bolder; padding:10px; font-size:22px; box-shadow: 3px 3px 5px grey;">
                    </div>
