...
if(isset($_POST['action']) && $_POST['action'] == 'senha'){
    ...
    if($resultado->num_rows > 0){
        ...
        $frase = "BatAtinh4Quando12345NascexexeEsparr4maPeloChao";
        $frase_secreta = str_shuffle($frase);//Embaralha a frase
        $token = substr($frase_secreta,0,10);//10 primeiro caracteres
        //echo "<p>$token</p>";
        ...
        // Este link deve ser enviado pelo e-mail
        echo $link;
    ...
    $busca = $sql->fetch();
    if($busca != null){ // !+= fica !=, que é diferente
    ...
    //Hash de senha / Codificação da senha em 40 caracteres
    $senha = sha1($senhaUsuario);
    ...
    if($senha != $senhaC){
        ...
        //Verificar de o Usuário já existe no bando de dados
